  ...
  return (
    <div id="projects" ref={sectionRef} className="app-showcase">
      <div className="w-full">
        ...
        <div className="mt-10 xl:mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            <div className="project flex flex-col gap-3 lg:col-span-1" ref={project1Ref}>
            ...
            <div className="project flex flex-col gap-3 lg:col-span-2" ref={project3Ref}>
              <GlowCard className="image-wrapper rounded-xl relative flex items-center justify-center">
            ...
            <div className="project flex flex-col gap-3 lg:col-span-1" ref={project2Ref}>
              <GlowCard className="image-wrapper rounded-xl relative flex items-center justify-center">
