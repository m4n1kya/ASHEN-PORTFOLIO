                      ...
                      <div className="mt-12 mb-8 flex flex-wrap justify-start gap-4">
                        {project.repoUrl && (
                          <a 
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex shrink-0 whitespace-nowrap justify-center items-center gap-3 px-8 py-3 rounded-full bg-white text-black font-bold hover:scale-105 transition-transform duration-300 shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)]"
                          >
