            ...
            <div className="w-full lg:w-[45%] lg:h-full relative z-10 pb-16 lg:pr-4">
              {projectsData.map(project => {
                ...
                return (
                  ...
                  >
                    <div className="prose prose-invert max-w-none pb-12 pr-4 lg:pr-8">
                      <div>
                        <ReactMarkdown 
                      ...
                      {/* Action Buttons */}
                      <div className="mt-12 mb-8 flex flex-wrap justify-start gap-4 overflow-visible">
                        {project.repoUrl && (
                          <a 
                            href={project.repoUrl}
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex shrink-0 !w-auto whitespace-nowrap justify-center items-center gap-3 !px-8 !py-3.5 rounded-full bg-white text-black font-bold hover:scale-105 transition-transform duration-300 shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)]"
                          >
