      ...
      <div className="flex-1 flex flex-col overflow-hidden relative z-10 pt-32 md:pt-24 bg-transparent">
        ...
        <div className="flex-1 overflow-y-auto lg:overflow-hidden relative z-10 flex flex-col bg-transparent">
          <div className="w-full flex-1 lg:h-full max-w-[1800px] mx-auto p-6 md:p-8 lg:p-12 xl:px-16 flex flex-col lg:flex-row gap-8 lg:gap-12 xl:gap-16">
                         ...
                         <div className="flex gap-3">
                            {project.liveUrl && isActive && (
                              <SpecularButton
                                ...
                                className="!bg-white !text-black shadow-[0_0_15px_rgba(255,255,255,0.2)]"
                              >
                            ...
                            {isActive && (
                              <SpecularButton
                                ...
                                className="!bg-black-300 border border-white-50/20 shadow-none"
                              >
                                <span className="flex items-center gap-2 font-bold">
            ...
            <div className="w-full lg:w-[45%] lg:h-full relative z-10 pb-16 lg:pr-4">
              {projectsData.map(project => {
                const isActive = project.id === activeTab;
                return (
                  <div 
                  ...
                  >
                    <div className="prose prose-invert max-w-none pb-12 pr-6 lg:pr-12">
                      <div>
                        <ReactMarkdown 
                      ...
                      {/* Action Buttons */}
                      <div className="mt-12 mb-8 flex flex-wrap justify-start gap-4 overflow-visible w-full">
                        {project.repoUrl && isActive && (
                          <SpecularButton
                            size="lg"
                            radius={24}
                            tint="#ffffff"
                            ...
                            autoAnimate={false}
                            onClick={() => window.open(project.repoUrl, "_blank")}
                            className="!bg-white !text-black shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.6)]"
                          >
                            <span className="flex shrink-0 justify-center items-center gap-3 font-bold">
                        ...
                        {project.liveUrl && isActive && (
                          <SpecularButton
                            ...
                            autoAnimate={false}
                            onClick={() => window.open(project.liveUrl, "_blank")}
                            className="!bg-transparent border border-white/20 shadow-[0_0_15px_rgba(255,255,255,0.05)] hover:shadow-[0_0_25px_rgba(255,255,255,0.25)]"
                          >
                            <span className="flex shrink-0 justify-center items-center gap-3 font-bold">
